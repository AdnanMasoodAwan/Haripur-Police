...
public class UserProfileActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        imageView=(ImageView)findViewById(R.id.UserProfile_Image_User);
        Email=(TextView) findViewById(R.id.Usermail);
        CNIC=(TextView) findViewById(R.id.UserNIC);
        Save=(Button) findViewById(R.id.SaveUserProfileButton);
 ...
 RetrieveUserInfo();
...

                    {
                        ...
                        if(snapshot.exists())
                        {
                            ...
                            if (users.getType().equals("User"))
                            {
                                ...
                                CNIC.setText(cnic);
                                Phone.setText(phone);
                                Picasso.with(UserProfileActivity.this).load(Pic).into(imageView);
                            }
                        }
    ...
    private void NameAlertDialog()
    {
        ...
        final EditText Input1=new EditText(UserProfileActivity.this);
    ...
    private void AboutAlertDialog()
    {
        ...
        final EditText Input2=new EditText(UserProfileActivity.this);
